...
#Objective: identify differential H3K4me3 peaks in JIB-04 versus DMSO treated OCI-Ly1 cells
...
counts.df <- counts.df[,c("DMSO_H3K4me3_REP1.mLb.clN.sorted.bam", "DMSO_H3K4me3_REP2.mLb.clN.sorted.bam", "JIB04_500nM_H3K4me3_REP1.mLb.clN.sorted.bam", "JIB04_500nM_H3K4me3_REP2.mLb.clN.sorted.bam")]
...
write.table(out[,c("chr", "start", "end", "baseMean", "log2FoldChange", "pvalue", "padj")],
            file = paste0(output_dir, "H3K4me3_DESeq2_JIB04_500nM_v_DMSO_Padj05.tsv"), 
            row.names = FALSE, 
            col.names = TRUE, 
            sep = "\t", 
            quote = FALSE)
...
pdf(file = paste0(output_dir, "H3K4me4_MA_plot_JIB04_500nM_v_DMSO.pdf"), width = 3, height = 3, useDingbats = FALSE)  
